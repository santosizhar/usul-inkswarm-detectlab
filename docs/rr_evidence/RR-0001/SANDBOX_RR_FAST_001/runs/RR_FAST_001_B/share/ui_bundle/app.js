...
window.__RUN_DATA__ = {
  "schema_version": 1,
  "generated_at_utc": "2025-12-19T20:43:40Z",
  "runs": [
    {
      "schema_version": 1,
      "generated_at_utc": "2025-12-19T20:43:40.132288Z",
      ...
      "artifacts": {
        "baseline_report_md": "runs/RR_FAST_001_B/reports/baselines_login_attempt.md",
        "run_summary_md": "runs/RR_FAST_001_B/reports/summary.md"
      },
      "baselines": {
        "login_attempt": {
          "target_fpr": 0.01,
          ...
          "labels": {
            "label_replicators": {
              "logreg": {
                "meta": {},
                "model_path": "RR_FAST_001_B/models/login_attempt/baselines/label_replicators__logreg.joblib",
                "status": "ok",
                "time_eval": {
              ...
              "rf": {
                "meta": {},
                "model_path": "RR_FAST_001_B/models/login_attempt/baselines/label_replicators__rf.joblib",
                "status": "ok",
                "time_eval": {
                  "fpr": 0.047619047619047616,
            ...
            "label_the_chameleon": {
              "logreg": {
                "meta": {},
                "model_path": "RR_FAST_001_B/models/login_attempt/baselines/label_the_chameleon__logreg.joblib",
                "status": "ok",
                "time_eval": {
                  "fpr": 0.0,
              ...
              "rf": {
                "meta": {},
                "model_path": "RR_FAST_001_B/models/login_attempt/baselines/label_the_chameleon__rf.joblib",
                "status": "ok",
                "time_eval": {
            ...
            "label_the_mule": {
              "logreg": {
                "meta": {},
                "model_path": "RR_FAST_001_B/models/login_attempt/baselines/label_the_mule__logreg.joblib",
                "status": "ok",
                "time_eval": {
                  "fpr": 0.0,
                  "pr_auc": 0.0,
              ...
              "rf": {
                "meta": {},
                "model_path": "RR_FAST_001_B/models/login_attempt/baselines/label_the_mule__rf.joblib",
                "status": "ok",
                "time_eval": {
                  "fpr": 0.0,
                  "pr_auc": 0.0,
          ...
          "paths": {
            "metrics_json": "runs/RR_FAST_001_B/models/login_attempt/baselines/metrics.json",
            "report_md": "runs/RR_FAST_001_B/reports/baselines_login_attempt.md",
            "baselines_log": "runs/RR_FAST_001_B/logs/baselines.log"
          }
        }
      },
      "eval": {
        "login_attempt": {
          "slices_report": "runs/RR_FAST_001_B/reports/eval_slices_login_attempt.md",
          "stability_report": "runs/RR_FAST_001_B/reports/eval_stability_login_attempt.md",
          "stability_summary": {
