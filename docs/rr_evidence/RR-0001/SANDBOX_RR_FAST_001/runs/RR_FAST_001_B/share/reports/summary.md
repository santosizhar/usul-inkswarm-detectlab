...
## Outputs written
- dataset/checkout_attempt/time_eval: `RR_FAST_001_B/dataset/checkout_attempt/time_eval.parquet` (parquet) — 5 rows
- dataset/checkout_attempt/train: `RR_FAST_001_B/dataset/checkout_attempt/train.parquet` (parquet) — 26 rows
- dataset/checkout_attempt/user_holdout: `RR_FAST_001_B/dataset/checkout_attempt/user_holdout.parquet` (parquet) — 3 rows
- dataset/login_attempt/time_eval: `RR_FAST_001_B/dataset/login_attempt/time_eval.parquet` (parquet) — 22 rows
- dataset/login_attempt/train: `RR_FAST_001_B/dataset/login_attempt/train.parquet` (parquet) — 156 rows
- dataset/login_attempt/user_holdout: `RR_FAST_001_B/dataset/login_attempt/user_holdout.parquet` (parquet) — 24 rows
- features/login_attempt/features: `RR_FAST_001_B/features/login_attempt/features.parquet` (parquet) — 202 rows
- features/login_attempt/manifest: `RR_FAST_001_B/features/login_attempt/feature_manifest.json` (json)
- features/login_attempt/spec: `RR_FAST_001_B/features/login_attempt/feature_spec.json` (json)
- raw/checkout_attempt: `RR_FAST_001_B/raw/checkout_attempt.parquet` (parquet) — 34 rows
- raw/login_attempt: `RR_FAST_001_B/raw/login_attempt.parquet` (parquet) — 202 rows
...
- detailed baseline report: `runs/RR_FAST_001_B/reports/baselines_login_attempt.md`
- baselines log: `runs/RR_FAST_001_B/logs/baselines.log`
