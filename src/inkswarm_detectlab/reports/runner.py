...
def _render_final_report(
    ...
    # Label semantics (so the report is shareable and self-contained)
    lines.append("## Synthetic label semantics")
    lines.append(
        "In the MVP, labels are generated by the synthetic Skynet dataset generator. They are **seeded and deterministic** "
        "given the generator configuration, but they represent **synthetic scenarios** (not real attacker ground truth). "
        "For deeper detail see `docs/labels_and_dataset.md` in the repo."
    )
    lines.append("")
